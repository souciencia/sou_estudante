...
const MODULOS = [
  { modulo: "m1", href: "/cursos/", rotulo: "Escolher curso", cor: "bg-m1-accent" },
  { modulo: "m2", href: "/ingresso/", rotulo: "Como ingressar", cor: "bg-m2-accent" },
  { modulo: "m3", href: "/permanencia/", rotulo: "Como permanecer", cor: "bg-m3-accent" },
  { modulo: "m4", href: "/instituicao/", rotulo: "Conhecer instituição", cor: "bg-m4-accent" },
  { modulo: "m5", href: "/comparar/", rotulo: "Comparar cursos", cor: "bg-m5-accent" },
];
...
export default function Menu({ mode='light' }: MenuProps) {
    ...
    useEffect(() => {
        ...
        const aoTeclar = (e: KeyboardEvent) => {
            ...
            const focaveis = drawerRef.current?.querySelectorAll<HTMLElement>(
                "button, a[href]",
            );
